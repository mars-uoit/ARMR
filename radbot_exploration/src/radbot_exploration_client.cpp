...
public:
        ...
        waiting_for_center_(false)
    {
        ...
        point_viz_timer_ = nh_.createWallTimer(ros::WallDuration(0.1), boost::bind(&RadbotExplorationClient::vizPubCb, this));
...
int main(int argc, char** argv)
{
    ...
    radbot_exploration::RadbotExplorationClient client;
    ros::spin();
    return 0;
}
